...
def welcome_assignment_answers(question):
    ...
    match question:
        case "In Slack, what is the secret passphrase posted in the #cyberfellows-computernetworking-fall2021 \
        ...
        case "Is a hashed message supposed to be un-hashed? - Yes/No":
            return "No"
        case "What is the MD5 hashing value to the following message: 'NYU Computer Networking' - \
        ...
        case "Is MD5 a secured hashing algorithm? - Yes/No":
            return "No"
        case "What layer from the TCP/IP model the protocol DHCP belongs to? - The answer should be a numeric number":
            return 5
        case "What layer of the TCP/IP model the protocol TCP belongs to? - The answer should be a numeric number":
            return 4
